    ...
    return(
        <div className="education-work">
            ...
            <Container className="text-start">
                ...
                <Row>
                    <SchoolWork dates={gg.dates} title={gg.title} subtitle={gg.subtitle} feature={gg.feature} paragraph={gg.paragraph} imagepath={google} imagelink={gg.imagelink} leftAligned={gg.leftAligned}/>
                </Row>
                <Row className="d-flex justify-content-center">
